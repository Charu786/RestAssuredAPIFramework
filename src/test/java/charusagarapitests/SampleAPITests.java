...
public class SampleAPITests extends BaseTest {
    ...
    public void testCreatePost(PostPayload payload) {
        String requestBody = "{ \"title\": \"fool\", \"body\": \"bar\", \"userId\": 1}";
            Response response = apiClient.postPost(payload);
    ...
    public Object[][] getData() throws Exception {
        return JsonUtils.getJSONData("src/test/resources/testdata.json");
    }
}
